...
<!DOCTYPE html>
<html  lang="en">
<title>Student Article | Futo | Futo Student's Forum</title>
<!--meta descriptions-->
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="inspiring article, students forum">
<!-- Links-->
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:43px;" id="mySidebar">
  ...
  <a  style="color:blue;" class="w3-bar-item w3-button w3-hover-black" href="article.php">Article</a>
</nav>
...
<div class="w3-row w3-padding-64">
		...
		<div class="w3-row">
			...
			<!-- carousel-->
					  ...
					  <p class="w3-border w3-padding-large w3-padding-64 w3-center"><img src="ads/canzona.jpg" alt="Canzona9"></p>
					</div>
		</div>
